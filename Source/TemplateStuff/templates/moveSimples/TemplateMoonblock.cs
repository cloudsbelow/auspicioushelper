...
public class TemplateMoonblock:Template{
  float floatfreq;
  ChannelState.Vec2Ch floatDir, sinkDir;
  ChannelState.FloatCh dashmagn, sinkSpeed;
  Vector2 offset;
  ...
  public TemplateMoonblock(EntityData d, Vector2 offset, int depthoffset):base(d,d.Position+offset,depthoffset){
    ...
    floatDir = d.ChannelVec2("drift_amplitude",0,4,true);
    sinkDir = d.ChannelVec2("sink_amount",0,12,true);
    dashmagn = d.ChannelFloat("dash_influence",8);
    sinkSpeed = d.ChannelFloat("sink_speed",1f);
