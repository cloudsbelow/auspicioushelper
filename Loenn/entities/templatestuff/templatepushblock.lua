...
entity.fieldOrder = {
  "x","y", "template","depthoffset","terminalVelocity","gravity","horizontalDrag","speedFromDash","NoPhysicsTime","movementLeniency","BounceStrengthFromWall","ownSpringRecoil","ImpactSfx"
}
